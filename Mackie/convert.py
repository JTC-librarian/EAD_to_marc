...
def create100(sub_series):
    ...
    sub_a = createSubfield('a')
    sub_a.text = 'Mackie, Philip'
    data100 = appendSubfields(data100, [sub_a])
    return data100
...
def create541(sub_series):
    ...
    sub_c.text = 'Gift;'
    sub_a.text = "Philip Mackie's daughter, Barbara Mackie;"
    sub_d.text = '2006'
    data541 = appendSubfields(data541, [sub_c, sub_a, sub_d])
    return data541
...
infile = open('gb3600-mac.xml', 'r', encoding='utf8', errors='ignore')
string = infile.read()
infile.close()
...
collection_tree.write('mackie-marcxml.xml', encoding='UTF-8', xml_declaration=True)
